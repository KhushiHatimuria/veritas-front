...
import RatingModal from "../Components/RatingModal"; // ✅ Rating popup
...
export default function HomeScreen() {
  ...
  // Show rating popup after 5 seconds
  useEffect(() => {
  ...
  const renderFooter = () => (
    <View style={{ paddingHorizontal: 16, marginTop: 18 }}>
      ...
      <View style={styles.bigCard}>
        ...
        <Text style={styles.bigCardText}>Another content block underneath.</Text>
      </View>
    </View>
  );
